...
command = """CREATE TABLE IF NOT EXISTS visitors(id INTEGER PRIMARY KEY, name TEXT NOT NULL, email TEXT UNIQUE NOT NULL, password TEXT NOT NULL, cpf TEXT NOT NULL, birthDate TEXT NOT NULL, visitDate TEXT NOT NULL, visitReason TEXT NOT NULL, isAdmin INTEGER NOT NULL)"""
...
cursor = connection.cursor()
command = """CREATE TABLE IF NOT EXISTS ponto(id INTEGER, name TEXT NOT NULL, email TEXT NOT NULL, cpf TEXT NOT NULL, birthDate TEXT NOT NULL, visitDate TEXT NOT NULL, visitReason TEXT NOT NULL)"""
cursor.execute(command)
