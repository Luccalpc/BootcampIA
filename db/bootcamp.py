...
cursor.execute("INSERT INTO visitors VALUES (1, 'Renan', 'renan@facens.br','Renan123', '429.443.628-01', '1995-01-14', 1 )")
cursor.execute("INSERT INTO visitors VALUES (2, 'Lucca', 'lucca@facens.br','Lucca123', '439.443.628-01', '1995-01-15', 1 )")
...
cursor = connection.cursor()
command = """CREATE TABLE IF NOT EXISTS ponto(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, email TEXT NOT NULL, cpf TEXT NOT NULL, birthDate TEXT NOT NULL, 
          visitDate TEXT NOT NULL, visitReason TEXT NOT NULL)"""
cursor.execute(command)
cursor.close() 
